...
public:
    ...
    void EnableTSens() { ADC->CCR |=  ADC_CCR_TSEN; }
    void DisableTSens(){ ADC->CCR &= ~ADC_CCR_TSEN; }
    uint32_t GetResult(uint8_t AChannel, Filtration_t AFiltration = Filt);
